                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.books.index')}}"> {{__("admin.languages")}} </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route("admin.books.update",$book->id)}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="text-center ">
                                                    <img src="{{asset($book->photo)}}"  class="thumbnail " width="300" height="300" alt="صورة القسم ">
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <p>{{__("admin.active")}}</p>
                                                            <div class="form-check form-check-inline">
                                                              <input class="form-check-input" type="radio" name="active" id="yes" {{$book->active == 1 ? "checked" : ''}} value="1">
                                                              <label class="form-check-label" for="yes">{{__("admin.enabled")}}</label>
                                                            </div>
                                                            <div class="form-check form-check-inline ml-4">
                                                               <input class="form-check-input" type="radio" name="active" id="no" value="0" {{$book->active == 0 ? "checked" : ''}}>
