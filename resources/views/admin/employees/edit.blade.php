                                             ...
                                             <div class="form-body">
                                                  ...
                                                  <div class="to-photo">
                                                       <div class="text-center ">
                                                          <img src="{{asset($employee->photo)}}"  class="thumbnail " width="300" height="300" alt="صورة القسم ">
                                                        </div>
                                                  </div>
                                                  ...
                                                  <div class="tab-content" id="nav-tabContent">
                                                    ...
                                                    <div class="tab-pane fade show {{$index == 0 ? 'active' : ''}}" id="nav-{{$module}}" role="tabpanel" aria-labelledby="nav-{{$module}}-tab">
                                                     ...
                                                     @foreach($permissions as $index => $permission)
                                                            <input type="checkbox" id="{{$permission . '_' . $module}}" {{$employee->hasPermissionTo($permission . '_' . $module) ? 'checked' : ''}} value="{{$permission . '_' . $module}}" name="permissions[]">
