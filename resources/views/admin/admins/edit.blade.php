                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="to-photo">
                                                    <div class="text-center ">
                                                        <img src="{{ asset($admin->photo) }}" class="thumbnail " width="300"
                                                            height="300" alt="صورة القسم ">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="tab-content" id="nav-tabContent">
                                                            ...
                                                            <div class="tab-pane fade show {{ $index == 0 ? 'active' : '' }}"
                                                                ...
                                                                @foreach ($permissions as $index => $permission)
                                                                    <input type="checkbox"
                                                                        ...
                                                                        {{ $admin->hasPermissionTo($permission . '_' . $module) ? 'checked' : '' }}
                                                        ...
                                                        <div class="tab-pane fade show " id="nav-reservations"
                                                            ...
                                                            @foreach ($perm_reservations as $index => $permission)
                                                                <input type="checkbox"
                                                                    {{ $admin->hasPermissionTo($permission . '_' . 'reservations') ? 'checked' : '' }}
